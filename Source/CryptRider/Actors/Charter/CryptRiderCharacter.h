...
UCLASS(config=Game)
class ACryptRiderCharacter : public ACharacter, public IPlayerInterFace
{
	GENERATED_BODY()
...
protected:
	...
	/** Called for Return input */
	void Return(const FInputActionValue& Value);
