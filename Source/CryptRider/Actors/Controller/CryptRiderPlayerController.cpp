...
{
	Super::BeginPlay();
	LoadClass<UClass>(ANY_PACKAGE, TEXT("/Game/UI/BP_MainUIC++.BP_MainUIC++_C"),
		nullptr, LOAD_None, nullptr);
	LoadClass<UClass>(ANY_PACKAGE, TEXT("/Game/UI/Inventory/UI_InventoryMenu.UI_InventoryMenu_C"),
		nullptr, LOAD_None, nullptr);

	{
		UClass* WidgetClass = FindObject<UClass>(ANY_PACKAGE, TEXT("/Game/UI/BP_MainUIC++.BP_MainUIC++_C"));
		if (WidgetClass)
		{
	...
	{
		UClass* WidgetClass = FindObject<UClass>(ANY_PACKAGE, TEXT("/Game/UI/Inventory/UI_InventoryMenu.UI_InventoryMenu_C"));
